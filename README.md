# Simple bot that used in order to make a proof of concept application.

Simple application based on telegram mini apps react template that is
used in order to write proof of concept for the miniapp interface for
libraries that are used in the company. And also learn programming pattern
used in react.
...
➜  Local:   https://localhost:5173/sirius-books-poc
➜  Network: https://172.18.16.1:5173/sirius-books-poc
➜  Network: https://172.19.32.1:5173/sirius-books-poc
➜  Network: https://192.168.0.171:5173/sirius-books-poc
...
link (`https://localhost:5173/sirius-books-poc` in this example) in your
browser:
